...
public class TileEntityRenderWindmill extends TileEntitySpecialRenderer {
    ...
    private final ResourceLocation textureWindmillsides = new ResourceLocation(Reference.MODID, "textures/model/windmillSides.png");
    private final ResourceLocation textureWindmillRotor = new ResourceLocation(Reference.MODID, "textures/model/rotor.png");
    ...
    private void drawRotor(TileEntity tileEntity) {
        ...
        tessellator.startDrawingQuads();
        {
            ...
            tessellator.addVertexWithUV(-2 * pixel, -2.5F, 1 * pixel + 0.5F, 9 * (1F / textureWidth), 1 * (1F / textureHeight));
            ...
            tessellator.addVertexWithUV(-2 * pixel, -2.5F, -1 * pixel + 0.5F, 8 * (1F / textureWidth), 1 * (1F / textureHeight));
            ...
            tessellator.addVertexWithUV(-2 * pixel, 0.5F + 1 * pixel, -2.5F, 8 * (1F / textureWidth), 0 * (1F / textureHeight));
            tessellator.addVertexWithUV(-2 * pixel, 0.5F - 1 * pixel, -2.5F, 8 * (1F / textureWidth), 1 * (1F / textureHeight));
        ...
        this.bindTexture(textureWindmillRotor);
        tessellator.startDrawingQuads();
        {
            tessellator.addVertexWithUV(-2 * pixel, 7 * pixel, 9 * pixel, 6 * (1F / 10), 6 * (1F / 10F));
            tessellator.addVertexWithUV(-2 * pixel, 9 * pixel, 9 * pixel, 6 * (1F / 10), 4 * (1F / 10F));
            tessellator.addVertexWithUV(-2 * pixel, 9 * pixel, 7 * pixel, 4 * (1F / 10), 4 * (1F / 10F));
            tessellator.addVertexWithUV(-2 * pixel, 7 * pixel, 7 * pixel, 4 * (1F / 10), 6 * (1F / 10F));

            tessellator.addVertexWithUV(-2 * pixel, 7 * pixel, 7 * pixel, 6 * (1F / 10), 6 * (1F / 10F));
            tessellator.addVertexWithUV(-2 * pixel, 9 * pixel, 7 * pixel, 6 * (1F / 10), 4 * (1F / 10F));
            tessellator.addVertexWithUV(0 * pixel, 9 * pixel, 7 * pixel, 4 * (1F / 10), 4 * (1F / 10F));
            tessellator.addVertexWithUV(0 * pixel, 7 * pixel, 7 * pixel, 4 * (1F / 10), 6 * (1F / 10F));


            tessellator.addVertexWithUV(0 * pixel, 7 * pixel, 9 * pixel, 6 * (1F / 10), 4 * (1F / 10F));
            tessellator.addVertexWithUV(0 * pixel, 9 * pixel, 9 * pixel, 6 * (1F / 10), 6 * (1F / 10F));
            tessellator.addVertexWithUV(-2 * pixel, 9 * pixel, 9 * pixel, 4 * (1F / 10), 6 * (1F / 10F));
            tessellator.addVertexWithUV(-2 * pixel, 7 * pixel, 9 * pixel, 4 * (1F / 10), 4 * (1F / 10F));


            tessellator.addVertexWithUV(0 * pixel, 9 * pixel, 9 * pixel, 6 * (1F / 10), 6 * (1F / 10F));
            tessellator.addVertexWithUV(0 * pixel, 9 * pixel, 7 * pixel, 6 * (1F / 10), 4 * (1F / 10F));
            tessellator.addVertexWithUV(-2 * pixel, 9 * pixel, 7 * pixel, 4 * (1F / 10), 4 * (1F / 10F));
            tessellator.addVertexWithUV(-2 * pixel, 9 * pixel, 9 * pixel, 4 * (1F / 10), 6 * (1F / 10F));
            ...
            tessellator.addVertexWithUV(-2 * pixel, 7 * pixel, 9 * pixel, 4 * (1F / 10), 4 * (1F / 10F));
            tessellator.addVertexWithUV(-2 * pixel, 7 * pixel, 7 * pixel, 4 * (1F / 10), 6 * (1F / 10F));
            tessellator.addVertexWithUV(0 * pixel, 7 * pixel, 7 * pixel, 6 * (1F / 10), 6 * (1F / 10F));
            tessellator.addVertexWithUV(0 * pixel, 7 * pixel, 9 * pixel, 6 * (1F / 10), 4 * (1F / 10F));
